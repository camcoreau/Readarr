...
>
> The upstream [Readarr project](https://github.com/Readarr/Readarr) is retired and its repository is archived. CamCore retains this fork as a source reference only and does not claim active maintenance, deployment, support or verified live operation. The upstream retirement announcement, documentation, attribution and licence are preserved below.
